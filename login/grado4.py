...
class cuarto:
        ...
        var.set ("Materias")
        opciones=["Castellano","Ciencias Biologicas","Fisica","Quimica","Geografía, historia y ciudadanía (GHC)","Ingles","Matematicas","Fomarcion para la soberanía nacional (FSN)","Orientación y convivencia ","Participación en grupos de creación, recreación y producción (G.E.R.P)"]
