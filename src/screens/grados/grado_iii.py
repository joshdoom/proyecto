...
def screen_grado_iii(tk: tkinter, window: Tk):
    ...
    def update_table():
        ...
        with Session(engine) as session:
            ...
            for estudiante in estudiantes:
                grado = session.query(ModelGrado).filter(ModelGrado.id_estudiante == estudiante.id, ModelGrado.inscrito == 3).first()
    ...
    def nuevo():
        ...
        with Session(engine) as session:
            ...
            connect_grado.create(3, estudiante.id)
    ...
    def guardar():
        ...
        with Session(engine) as session:
            ...
            connect_grado.update(grado.id, 3, estudiante.id)
    ...
    def notas():
        ...
        window.destroy()
        screen_notas(tkinter, window=tk.Toplevel(), degree=3)

    window.title("Tercer año")
