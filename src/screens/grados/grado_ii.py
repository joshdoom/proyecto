...
def screen_grado_ii(tk: tkinter, window: Tk):
    ...
    def update_table():
        ...
        with Session(engine) as session:
            ...
            for estudiante in estudiantes:
                grado = session.query(ModelGrado).filter(ModelGrado.id_estudiante == estudiante.id, ModelGrado.inscrito == 2).first()
    ...
    def nuevo():
        ...
        with Session(engine) as session:
            ...
            connect_grado.create(2, estudiante.id)
